...
namespace ASCOM.LifeRoof.Dome
{
    ...
    //
    // The COM Guid attribute sets the CLSID for ASCOM.LifeRoof.Dome
    // The COM ClassInterface/None attribute prevents an empty interface called _LifeRoof from being created and used as the [default] interface
    //
    ...
    /// </summary>
    [ComVisible(true)]
    [Guid("f5a887df-02b2-4e5a-bf28-5466454434a0")]
    [ProgId("ASCOM.LifeRoof.Dome")]
    [ServedClassName("ASCOM Dome Driver for LifeRoof")] // Driver description that appears in the Chooser, customise as required
    ...
    public class Dome : ReferenceCountedObjectBase, IDomeV2, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LifeRoof"/> class. Must be public to successfully register for COM.
        /// </summary>
        public Dome()
        {
            try
            {
                ...
                tl = new TraceLogger("", "LifeRoof.Driver"); // Remove the leading ASCOM. from the ProgId because this will be added back by TraceLogger.
                SetTraceState();
